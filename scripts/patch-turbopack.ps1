# Auto-generated patch for OpenNext Windows compatibility
# Applied via postinstall in package.json
$file = "node_modules/@opennextjs/cloudflare/dist/cli/build/patches/plugins/turbopack.js"
if (Test-Path $file) {
    [System.IO.File]::WriteAllText((Resolve-Path $file), @'
...
'@)
    Write-Host "Patched turbopack.js for Windows compatibility"
}
