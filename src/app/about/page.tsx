...
export default function AboutPage() {
  ...
  <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: `url(${resolveImageUrl(get("about_hero_image")) || "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&h=600&fit=crop"})` }} />
