...
function defaults(): SettingsMap {
  return {
    ...
    seo_hausa_keywords: "gidan siyarwa kano, gidan haya kano, sayar da gida, nema gidan haya, gidan kano, fatacin gida, plaza kano, kasuwa gida, gidan siya, property kano, house for sale kano, house for rent kano, flat kano, land kano, commercial property kano",
