...
export default function CustomOrderPage() {
  ...
  return (
    <div className="flex-1 py-16 px-4 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-xl mx-auto animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-lg space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)] transition-all resize-none"
            />
          </div>
