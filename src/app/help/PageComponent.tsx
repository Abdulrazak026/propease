...
export default function HelpPage() {
  ...
  const whatsapp = (g("support_whatsapp") || "2347074222284").replace(/[^0-9]/g, "");
  const whatsappMsg = encodeURIComponent("Hi! I have a question and need help from MBPP support.");
  const phone = (g("support_phone") || "+2347074222284").replace(/[^0-9+]/g, "");
    ...
    <div className="flex flex-col">
      <section className="relative bg-gray-950 overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="MBPP Properties help and support center" className="w-full h-full object-cover opacity-50" />
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <div className="mt-8 space-y-4">
                <a href={`https://wa.me/${whatsapp}?text=${whatsappMsg}`} target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
                  <div className="shrink-0 w-12 h-12 rounded-xl bg-brand-blue/5 text-brand-blue flex items-center justify-center group-hover:bg-brand-blue/10 transition-colors">
        ...
        <div className="relative bg-gray-950 rounded-3xl overflow-hidden p-10 sm:p-14 lg:p-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <a href={`https://wa.me/${whatsapp}?text=${whatsappMsg}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center min-h-[52px] px-7 py-3.5 text-sm font-semibold rounded-full border border-white/20 text-white hover:bg-white/5 transition-all">
                Open WhatsApp
              </a>
            </div>
          </div>
