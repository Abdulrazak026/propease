    ...
    <div className="flex flex-col">
      <section className="relative bg-gray-950 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1600&h=900&fit=crop" alt="" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <div className="mt-8 space-y-4">
                <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
                ...
                <a href="tel:+2348000000000" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">+234 800 000 0000 · Mon–Fri 8am–6pm, Sat 10am–2pm.</p>
                  </div>
                </a>
                <a href="mailto:hello@mbpp.ng" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">hello@mbpp.ng · Replies within 4 business hours.</p>
                  </div>
                </a>
              </div>
            </div>
