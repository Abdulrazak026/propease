  ...
  return (
    <div className="flex-1">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6 pb-12">
        <Link href="/list-property" className="inline-flex items-center gap-2 text-sm font-medium text-brand-blue hover:text-brand-blue-light transition-colors mb-4 bg-brand-blue/10 px-3.5 py-2 rounded-lg">
