    ...
    <div className="flex flex-col">
          ...
          <div className="absolute top-4 right-5 sm:right-6 lg:right-10 z-10" id="hero-more">
            ...
            {heroMoreOpen && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-xl border border-gray-100 shadow-xl shadow-gray-900/5 p-3 z-50">
                {HERO_MORE_ITEMS(!!isAuthenticated, role === "head" || role === "admin" || role === "ambassador" || role === "agent").map((item, i) => (
                  <div key={item.href || "logout"}>
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 rounded-xl bg-gray-50/50 px-4 py-3">
            {[
              ...
              <div key={s.l} className="flex items-center justify-center gap-2 sm:gap-3">
