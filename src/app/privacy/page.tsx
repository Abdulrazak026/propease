export default function PrivacyPage() {
 ...
 <p>
 MBPP ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
 </p>
 ...
 <p>
 For privacy-related inquiries, contact us at <strong>privacy@mbpp.ng</strong> or visit our <a href="/contact" className="text-[var(--color-primary)] hover:underline">Contact page</a>.
 </p>
 </div>
 </div>
 </div>
