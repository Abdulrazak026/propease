    ...
    <div className="flex-1 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
          <p>
            By accessing or using PropEase ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Platform.
          </p>

          <h2 className="text-lg font-semibold text-gray-900">1. Definitions</h2>
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>Platform</strong> — PropEase website and associated services</li>
          ...
          <p>
            Users must provide accurate information during registration. You are responsible for maintaining the confidentiality of your account credentials. PropEase reserves the right to suspend or terminate accounts that violate these terms.
          </p>
          ...
          <p>
            Property listings are provided by ambassadors and verified agents. PropEase facilitates connections but does not guarantee the accuracy of all listing details. Users should verify property information independently before making commitments.
          </p>
          <p>
          ...
          <p>
            PropEase is a marketplace platform and is not a party to any transaction between users. We are not liable for disputes between landlords, tenants, agents, or ambassadors. Our liability is limited to the maximum extent permitted by Nigerian law.
          </p>
