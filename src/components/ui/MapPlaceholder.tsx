export default function MapPlaceholder({ lat, lng, label }: { lat: number; lng: number; label?: string }) {
 return (
 <div className="relative bg-gray-200 rounded-lg overflow-hidden h-48 w-full">
 ...
 <div className="absolute bottom-2 left-2 bg-white/90text-[10px] px-2 py-1 rounded-lg text-gray-500 flex items-center gap-1">
